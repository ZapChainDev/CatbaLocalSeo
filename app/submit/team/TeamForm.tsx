...
import { submitTeam } from "@/lib/actions/submit";
import type { Sport, League } from "@/lib/supabase/types";
...
export default function TeamForm({
  ...
  const [state, action] = useActionState(submitTeam, { success: false });
    ...
    return (
      <div className="rounded-xl border border-green-200 bg-green-50 p-8 text-center">
        ...
        <p className="text-green-700">
          Your team is under review and will appear on the site once approved.
        </p>
      </div>
    );
  }
